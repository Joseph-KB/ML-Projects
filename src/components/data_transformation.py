...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            logging.info(f"Categorical Coloumns/feature : {categorical_features}")
            logging.info(f"Numberical Coloumns/feature : {numerical_features}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            target_coloumn_name="math score"
            numerical_coloumn =  ['reading score', 
                                   'writing score']
